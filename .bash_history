...
git add .
git log
git commit -m "ejercicios_python_listas"
git pull origin master
git push origin master
source punto_files/.bashrc
cd ejercicios_python/listas_tuplas/
...
git log
git add .
git commit -m "ejercicios_listas_pythno_2"
git pull origin master
git push origin master
git log
/bin/python3.9
...
git add .
git log
git commit -m "ejercicios_listas_python_3"
git pull origin master
git push origin master
source punto_files/.bashrc
all
...
cd ejercicio_pandas/
code .
python3 students_performance.py
cd ..
...
git add .
git log
git commit -m "ejercicio1_pandas"
git pull origin master
git push origin master
git log
git pull origin master
git status
git add .
git commit -m "ejercicio1.2_pandas"
git pull origin master
explorer.exe .
git pull origin master
