...
#Crear variable opción igual a variable menu como Input, y en Int, para las condiciones.
...
#Convierto la variable dolar en string para poder mostrarla en pantalla con print.
